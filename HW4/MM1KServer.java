...
class MM1KServer extends EventGenerator {
    ...
    private int droppedReqs = 0;
    private int snapCount = 0;
    private int servedReqs = 0;
    private int k;
    
    public MM1KServer (Timeline timeline, Double servTime, int k) {
	super(timeline);
	...
	if (this.name == null) {
		...
		System.out.println(this.name + " DROPPED: " + droppedReqs);
